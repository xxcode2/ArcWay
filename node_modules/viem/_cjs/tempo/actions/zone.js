...
exports.waitForDepositStatus = waitForDepositStatus;
...
async function waitForDepositStatus(client, parameters) {
    ...
    timer = timeout
        ? setTimeout(() => {
            reject_(new errors_js_1.WaitForDepositStatusTimeoutError({ tempoBlockNumber }));
        }, timeout)
        : undefined;
